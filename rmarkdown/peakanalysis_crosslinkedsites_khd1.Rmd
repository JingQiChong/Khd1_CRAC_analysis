...
---
##Summary
This script extracts sequences near the Khd1 cross-linked peaks (+/-75 bases) and put them into a fasta file. 
In the fasta file, some sequences have length >150 because some of the cross-linked peaks are very close together and the sequences that overlapped are merged together.  
...
```{r load_data }
Khd1_SRR847751_df <- read_pileuptxt("~/CRAC_analysis_2022/khd1/khd1_SRR847751/pyPileup_analyses/SRR847751_trimmed_pileups.txt")
...
for (i in all_motifs) {
  ...
  write_delim(., file = "~/CRAC_analysis_2022/khd1/khd1_SRR847751/MEME/Khd1_Targetgenes_del5_50.fa", quote = "none", col_names = FALSE, append = TRUE)
}
